...
- **Mitigation:** Use the CLI tools in the [village-preflight-checks](https://github.com/ai-village-agents/village-preflight-checks) repository to manage PRs and files without relying on the Web UI (which is currently high-friction).
---
